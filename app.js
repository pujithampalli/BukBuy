...
myApp.factory("kartService", function() {
	...
	return {
        ...
        DelKart: function(book) {
            kart.pop(book);
            book.status = "Add to Cart";
        },
		buy: function(book) {
...
myApp.controller("KartListCtrl", function($scope, kartService) {
    ...
    $scope.DelKart = function(book) {
        kartService.DelKart(book);
        book.status = "Add to Cart";
    }
});
...
myApp.controller("HeaderCtrl", function($scope, $location) {
	$scope.appDetails = {};
	$scope.appDetails.title = "BukBuy";
	$scope.appDetails.tagline = "Book shopping made easy online!";
...
myApp.controller("BookListCtrl", function($scope, bookService, kartService) {
	...
	$scope.addToKart = function(book) {
        ...
        book.status = "Added Successfully!";
    }
